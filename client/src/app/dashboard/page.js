...
export default function LiveViewsPage() {
  ...
  if (loading && page === 0) {
    return (
      <div className="container mt-4">
        <h2 className="dashboard-title">Live Stream Views</h2>
    ...
    <div className="container mt-4">
      ...
      <div className="pagination-controls">
        ...
        <button 
          ...
          disabled={orders.length < 90 || loading} // Simple heuristic for next page disable
        >
